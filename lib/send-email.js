...
export async function sendVerificationEmail(email, token) {
  ...
  console.log("[SendEmail] Sending verification email to:", email)
  ...
  if (result?.error) {
    console.error("[SendEmail] Resend returned error:", JSON.stringify(result.error))
  } else {
    console.log("[SendEmail] Sent OK, id:", result?.data?.id)
  }
}
